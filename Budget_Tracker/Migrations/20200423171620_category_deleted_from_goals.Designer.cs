...
namespace Budget_Tracker.Migrations
{
    ...
    [Migration("20200423171620_category_deleted_from_goals")]
    partial class category_deleted_from_goals
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Budget_Tracker.Models.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Budget_Tracker.Models.Goal", b =>
                {
                    b.HasOne("Budget_Tracker.Models.Category", null)
                        .WithMany("Goals")
                        .HasForeignKey("CategoryId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Budget_Tracker.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
